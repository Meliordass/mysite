...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=ROOT / r'D:\DLModles\weights\yolov5n-7-k5.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / r'D:\DLModles\datas\vec\data.yaml', help='dataset.yaml path')
